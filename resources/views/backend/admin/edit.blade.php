...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-3">Edit Admin Account</h3>
                    ...
                    @endif
                    <form action="{{ route('admin.account.destroy', $admin->id) }}" id="delete-form" class="d-none"
                        method="POST">
                        @csrf
                        @method('DELETE')
                    </form>
                    <form class="custom-validation" action="{{ route('admin.account.update', $admin->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
